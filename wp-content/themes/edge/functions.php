...
function edge_setup() {
	...
	register_nav_menus( array(
		...
		'content' => __( 'Content Menu', 'edge' ),
		'footermenu' => __( 'Footer Menu', 'edge' ),
		'knowledg-menu' => __( 'Knowledg Menu', 'edge' ),
		'kh-scheduler-menu' => __( 'KH-SCHEDULER Menu', 'edge' ),
		'mobile-menu' => __( 'Mobile Menu', 'edge' ),
		'other-mobile-menu' => __( 'Other Mobile Menu', 'edge' ),
	) );
...
if(!class_exists('Edge_Plus_Features') && !class_exists('Alternative_Customize_upgrade')){
	class Edge_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			<a title="<?php esc_attr_e( 'Review Edge', 'edge' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/edge/' ); ?>" target="_blank" id="about_edge">
			<?php esc_html_e( 'Review Edge', 'edge' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/edge/' ); ?>" title="<?php esc_attr_e( 'Theme Instructions', 'edge' ); ?>" target="_blank" id="about_edge">
			<?php esc_html_e( 'Theme Instructions', 'edge' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com' ); ?>" title="<?php esc_attr_e( 'Support Ticket', 'edge' ); ?>" target="_blank" id="about_edge">
